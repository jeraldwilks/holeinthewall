...
function AdminDashboard(props) {
  ...
  const [openPage, setOpenPage] = useState(<Test />);
    ...
    <div>
      ...
      <List>
        <ListItem key="dashboard" disablePadding>
          <ListItemButton onClick={() => setOpenPage(<Test />)}>
            <ListItemIcon>
              <DashboardIcon />
            </ListItemIcon>
        ...
        <ListItem key="addReview" disablePadding>
          <ListItemButton onClick={() => setOpenPage(<NewReview />)}>
            <ListItemIcon>
              <RateReviewIcon />
            </ListItemIcon>
